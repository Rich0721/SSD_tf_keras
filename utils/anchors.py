...
class PriorBox:
    ...
    def call(self, input_shape):
        ...
        layer_width = input_shape
        layer_height = input_shape
...
def get_anchors(img_size=(300, 300)):
    ...
    conv4_3_norm_mbox_pirorbox = priorbox.call(features_map_length[0])


    priorbox = PriorBox(img_size, 60.0, max_size=111.0, aspect_ratios=[2, 3],
                        variances=[0.1, 0.1, 0.2, 0.2],
                        name='fc7_mbox_priorbox')
    fc7_mbox_priorbox = priorbox.call(features_map_length[1])

    priorbox = PriorBox(img_size, 111.0, max_size=162.0, aspect_ratios=[2, 3],
                        variances=[0.1, 0.1, 0.2, 0.2],
                        name='conv6_2_mbox_priorbox')
    conv6_2_mbox_priorbox = priorbox.call(features_map_length[2])

    priorbox = PriorBox(img_size, 152.0, max_size=213.0, aspect_ratios=[2, 3],
                        variances=[0.1, 0.1, 0.2, 0.2],
                        name='conv7_2_mbox_priorbox')
    conv7_2_mbox_priorbox = priorbox.call(features_map_length[3])


    priorbox = PriorBox(img_size, 213.0, max_size=264.0, aspect_ratios=[2],
                        variances=[0.1, 0.1, 0.2, 0.2],
                        name='conv8_2_mbox_priorbox')
    conv8_2_mbox_priorbox = priorbox.call(features_map_length[4])

    priorbox = PriorBox(img_size, 264.0, max_size=315.0, aspect_ratios=[2],
                        variances=[0.1, 0.1, 0.2, 0.2],
                        name='pool6_mbox_priorbox')
                        
    pool6_mbox_priorbox = priorbox.call(features_map_length[5])

    mbox_priorbox = np.concatenate([conv4_3_norm_mbox_pirorbox,
                                    fc7_mbox_priorbox,
                                    conv6_2_mbox_priorbox,
                                    conv7_2_mbox_priorbox,
                                    conv8_2_mbox_priorbox,
                                    pool6_mbox_priorbox], axis=0)
