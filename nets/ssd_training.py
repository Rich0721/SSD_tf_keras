...
class MultiboxLoss(object):
    ...
    def compute_loss(self, y_true, y_pred):
        ...
        confs_starts = 4 + self.background_label_id + 1
        confs_end = confs_starts + self.num_classes - 1

        max_confs = tf.reduce_max(y_pred[:, :, confs_starts:confs_end], axis=2)
...
class Generator(object):
    ...
    def __init__(self, bbox_util, batch_size, train_lines, val_lines,
