...
def conv_block(inputs, filters, alpha, kernel=(3, 3), strides=(1, 1)):
    ...
    x = ZeroPadding2D(((0, 1), (0, 1)), name="conv1/padding")(inputs)
    x = Conv2D(filters, kernel, strides=strides, padding='same', use_bias=False, name='conv1')(x)
...
def SSD300(img_size, n_classes, l2_regularization=5e-4,
    ...
    conv = conv_block(x, 32, alpha=1, strides=(1, 1))
